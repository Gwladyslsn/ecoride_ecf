...
<section class="body-font">
    <div class="container px-5 py-12 mx-auto">
        ...
        <form method="post" class="flex lg:w-1/1 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
            <div class="relative flex-grow w-full">
                <label for="departureCity" class="leading-7 text-lg">Ville de départ</label>
                <input type="text" id="departure_city_search" name="" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative flex-grow w-full">
                <label for="arrivalCity" class="leading-7 text-lg">Ville d'arrivée</label>
                <input type="text" id="arrival_city_search" name="" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative flex-grow w-full">
                <label for="date" class="leading-7 text-lg">date</label>
                <input type="date" id="date_search" name="date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-transparent focus:ring-2 focus:ring-green-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <button id="btn_search" class="border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg btn-search">
                <a  >Rechercher</a>
            </button>
        </form>
